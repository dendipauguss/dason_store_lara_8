            ...
            <div class="card-header bg-white">
                <div class="home-tab">
                    <div class="btn-wrapper">
                        <a href="#modal-form" class="btn btn-primary modal-tambah text-white">Tambah Data</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    data.map(function(val, index) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="home-tab">
                                    <div class="btn-wrapper">
                                        <a href="#modal-form" data-id="${val.id}" class="btn btn-warning text-white me-0 modal-ubah">
